...
namespace CourseProject.Controllers
{
    public class ItemController : Controller
    {
        ...
        public ItemController(IAccountService accountService, ICollectionRepository collectionRepository, ICollectionPropertyRepository collectionPropertyRepository, IItemRepository itemRepository, IPropertyRepository propertyRepository)
        {
        ...
        public async Task<IActionResult> CollectionItems(Guid collectionId)
        {
            ...
            ViewBag.IsOwner = collection.UserId == await _accountService.GetUserIdAsync(User);
